...
const styles = StyleSheet.create({
  ...
  attachmentDoc: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: 'transparent', borderWidth: StyleSheet.hairlineWidth, borderColor: 'rgba(76, 29, 149, 0.15)', borderRadius: 10, paddingHorizontal: 10, paddingVertical: 8, maxWidth: 260 },
