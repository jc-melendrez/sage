    ...
    <View style={styles.attachmentList}>
      {msg.attachments.map((att, i) => {
        ...
        return isImageMime(att.mime) ? (
          ...
          <TouchableOpacity
            key={sourceKey}
            style={[styles.attachmentDoc, isMe && { backgroundColor: 'rgba(255,255,255,0.18)', borderColor: 'rgba(255,255,255,0.25)' }]}
...
const styles = StyleSheet.create({
  ...
  attachmentDoc: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: 'rgba(139, 92, 246, 0.08)', borderWidth: 1, borderColor: COLORS.borderStrong, borderRadius: 10, paddingHorizontal: 10, paddingVertical: 8, maxWidth: 260 },
